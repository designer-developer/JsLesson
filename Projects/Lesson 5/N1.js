...
let start1 = document.querySelector("#start"),                           // Кнопка "Начать расчет"
    ...
    area = document.querySelectorAll(".expenses-item"),                  // Поля(input) c обязательными расходами
    confirm = document.querySelector("button.expenses-item-btn"),        // Кнопки “Утвердить” и “Рассчитать”
    ...
    sum = document.querySelector('#sum'),                                // Поле суммы
